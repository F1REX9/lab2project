...
2. [Варианты использования](#use_case)
   ...
   2.6 [Добавить товар в корзину](#add_to_cart)

   2.7 [Просмотреть историю покупок](#see_history_buy)

   2.8 [Просмотреть историю просмотров](#see_history_view)

   2.9 [Купить товар](#purchase_product)
...
## 2.8 Просмотр истории просмотров
